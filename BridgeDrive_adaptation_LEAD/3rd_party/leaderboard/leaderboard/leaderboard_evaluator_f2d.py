...
import socket, subprocess, atexit, time
...
class LeaderboardEvaluator(object):
    ...
    def _setup_simulation(self, args):
        ...
        cmd1 = f"{os.path.join(self.carla_path, 'CarlaUE4.sh')} -quality-level=Epic -resx=800 -resy=600 -RenderOffScreen -nosound -carla-rpc-port={args.port}"
