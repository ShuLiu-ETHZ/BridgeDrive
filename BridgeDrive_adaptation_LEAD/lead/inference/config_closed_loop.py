...
class ClosedLoopConfig(OpenLoopConfig):
    ...
    # BridgeDrive
    viz_downsample_factor: int = 2 # draw 1 image in every viz_downsample_factor step
    collision_gradual_brake: bool = True # gradually brake when collision is predicted
